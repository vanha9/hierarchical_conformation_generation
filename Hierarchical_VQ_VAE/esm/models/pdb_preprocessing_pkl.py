...
for i in range(1,6):
    coordinates = pdb_to_atom37_tensor(f"/data/esmdiff_target/bpti_kinetic_cluster/bpti_5/bpti_{i}.pdb")
    ...
    # .ptm 파일로 저장
    torch.save(codebooks, f"/data/esmdiff_target/bpti_kinetic_cluster/bpti_5/bpti_{i}.ptm")
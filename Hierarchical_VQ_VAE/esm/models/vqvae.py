...
class StructureTokenEncoder(nn.Module):
    ...
    def find_knn_edges(
        ...
        with torch.no_grad(), torch.amp.autocast("cuda", enabled=False):  # type: ignore
            ca = coords[..., 1, :]
    ...
    def encode(
        ...
        z_q, min_encoding_indices, endocer_loss = self.codebook(z)

        return z_q, min_encoding_indices, endocer_loss

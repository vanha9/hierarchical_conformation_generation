...
class EMACodebook(nn.Module):
    def __init__(
        ...
        self.N = torch.zeros(n_codes)
        self.z_avg = self.embeddings.data.clone()
    ...
    def forward(self, z):
        ...
        commitment_loss = F.mse_loss(z.detach(), embeddings, reduction='none')
        codebook_loss = F.mse_loss(z, embeddings.detach(), reduction='none')
        ...
        return embeddings_st, encoding_indices, (commitment_loss+codebook_loss) * 0.25
